...
func (s *AuthService) Register(c *fiber.Ctx) error {
	...
	// Role selalu ditentukan server sebagai 'user' (mencegah mass assignment)
...
func (s *AuthService) Login(c *fiber.Ctx) error {
	...
	if err != nil {
		// Jalankan dummy hash agar waktu respons sama persis (mencegah user enumeration)
...
func (s *AuthService) Refresh(c *fiber.Ctx) error {
	...
	// ROTASI: token lama dicabut sebelum token baru diterbitkan
...
func (s *AuthService) issueTokenPair(
	...
	// Simpan dalam bentuk SHA-256 hash
