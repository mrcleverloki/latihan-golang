...
// accessClaims adalah isi access token. Ditambahkan username dan role
// agar middleware tidak perlu query ke database setiap kali request.
...
func (m *JWTManager) Parse(tokenString string) (model.AuthUser, error) {
	...
	token, err := jwt.ParseWithClaims(tokenString, claims,
		func(t *jwt.Token) (any, error) {
			// Pastikan algoritma token adalah HMAC (mencegah algorithm confusion "none")
